globalThis.__timing__.logStart('Load chunks/build/error-404-DQ_MN1XH');import { mergeProps, withCtx, createTextVNode, toDisplayString, defineComponent, shallowRef, h, resolveComponent, computed, useSSRContext } from 'vue';
...
import { u as useHead } from './v3-BTrMiri5.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
import 'node:buffer';
...
export { error404 as default };;globalThis.__timing__.logEnd('Load chunks/build/error-404-DQ_MN1XH');
//# sourceMappingURL=error-404-DQ_MN1XH.mjs.map
